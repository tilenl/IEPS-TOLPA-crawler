...
- MUST persist discovered-link edges atomically with page outcome persistence via `persistFetchOutcomeWithLinks(...)`; crash window between page outcome and discovered-link ingestion is not allowed (`TS-02`, `TS-10`).
